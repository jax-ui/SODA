...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--num_neighbors', type=int, default=0, help='number of neighbors to sample for each node')
    ...
    parser.add_argument('--CN_num_epochs', type=int, default=5, help='number of epochs of training CN model')
    parser.add_argument('--AD_num_epochs', type=int, default=5, help='number of epochs of training AD model')
    ...
    parser.add_argument('--focal_weighting', action='store_true', default=False, help='logit adjustment')
    parser.add_argument('--anomaly_ratio', type=float, default=0.0, help='ratio of anomaly')
    ...
    #bound guided
    parser.add_argument('--AD_layer', type=str, help='task layer used to detect anomalies', default='CNFlow',
                        choices=['MLP', 'CNFlow'])
    #imbalance config
    parser.add_argument('--loss_type', type=str, help='task loss to be used', default='CE',
                        choices=['CE', 'LDAM', 'VS', 'Focal'])
    parser.add_argument('--train_rule', type=str, help='train rule', default='None',
                        choices=['None', 'Reweight', 'DRW', 'DRW-T', 'ADRW', 'ADRW-T'])
