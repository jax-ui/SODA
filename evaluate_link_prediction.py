    ...
    for run in range(args.num_runs):
        ...
        if args.model_name == 'TGAT':
            ...
            dynamic_backbone = TCL(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=full_neighbor_sampler,
                                    ...
                                    num_depths=args.num_neighbors, dropout=args.dropout, device=args.device)
            ...
            dynamic_backbone = FreeDyG(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=full_neighbor_sampler,
        ...
        load_model_folder = f"./saved_models/{args.model_name}/{args.dataset_name}/{args.load_model_name}/{args.anomaly_ratio}/"
        ...
        save_result_folder = f"./saved_results/{args.model_name}/{args.dataset_name}/{args.anomaly_ratio}/"
