...
from models.modules import TimeEncoder, MultiHeadAttention,ConcatLayer
...
class TGAT(nn.Module):
    ...
    def __init__(self, node_raw_features: np.ndarray, edge_raw_features: np.ndarray, neighbor_sampler: NeighborSampler,
        ...
        self.merge_layers = nn.ModuleList([ConcatLayer(input_dim1=self.node_feat_dim + self.time_feat_dim, input_dim2=self.node_feat_dim,
